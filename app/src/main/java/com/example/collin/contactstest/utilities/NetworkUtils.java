...
public class NetworkUtils {
    ...
    public static String getResponseFromHttpUrl() throws IOException {
        ...
        HttpURLConnection urlConnection = (HttpURLConnection) new URL(url).openConnection();                  //This class is used to create an HTTP connection and gather JSON data from the url provided
